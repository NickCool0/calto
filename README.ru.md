...
- 🍎 **Нативное**: SwiftUI + AppKit, поповер Liquid Glass, русский и английский, ни одной сторонней зависимости.
...
| <kbd>⌘</kbd><kbd>↩</kbd> | Распознать · добавить проверенные события |
...
1. Вставьте или перетащите то, что есть: скриншот переписки, афишу, письмо — или просто напишите
   *«Обед с Аней завтра в 13»*.
2. При желании добавьте инструкцию: *«только встречи с Аней»*, *«напомни за час»*.
3. Нажмите **Распознать**, проверьте карточки, поправьте что нужно и нажмите **Добавить в Календарь**.
...
У каждой сборки новая ad-hoc подпись, и macOS считает её новым приложением. Разрешите доступ ещё раз.
</details>
...
- [x] Ввод: вставка, перетаскивание, инструкция, глобальная горячая клавиша
